...
hi perlControl				gui=NONE        ctermfg=59	 guifg=#c0c090	guibg=gray15
hi perlFunctionName			gui=NONE        ctermfg=white 	 guifg=white 	guibg=bg
hi perlIdentifier			gui=NONE	    ctermfg=75     guifg=gray75    guibg=NONE
hi perlLabel				gui=NONE        ctermfg=59	 guifg=#c0c090	guibg=gray15
hi perlMatchStartEnd		gui=NONE        ctermfg=59	 guifg=#c0c090	guibg=gray14
hi perlNumber				gui=NONE        ctermfg=22
hi perlOperator				gui=NONE        ctermfg=59	     guifg=#c0c090	guibg=bg
hi perlPackageDecl			gui=NONE        ctermfg=22	 guifg=#80ac7b	guibg=gray15
hi perlQQ					gui=NONE        ctermfg=18		 guifg=fg		guibg=gray15
hi perlRepeat				gui=NONE        ctermfg=22	 guifg=#c0b790	guibg=bg
hi perlSharpBang			gui=NONE        ctermfg=59	 guifg=#c0c090	guibg=gray10
hi perlShellCommand			gui=NONE        ctermfg=19   guifg=lightred  guibg=bg
hi perlSpecialBEOM			gui=NONE        ctermfg=19		 guifg=fg		guibg=gray15
hi perlSpecialMatch			gui=NONE        ctermfg=22	 guifg=#c864c7	guibg=bg
hi perlSpecialString		gui=NONE        ctermfg=22	 guifg=#dc966b	guibg=bg
hi perlStatement			gui=NONE	    ctermfg=59	 guifg=#c0c090	guibg=NONE
hi perlStatementControl		gui=NONE        ctermfg=22	 guifg=#dcdb6b	guibg=bg
hi perlStatementFiledesc	gui=NONE        ctermfg=59	 guifg=#a2c090	guibg=bg
hi perlStatementHash		gui=NONE	    ctermfg=59	 guifg=#c0c090	guibg=gray12
hi perlStatementInclude 	gui=NONE        ctermfg=59    guifg=#c0c090   guibg=bg
hi perlStatementNew			gui=underline   ctermfg=59	 guifg=#c0c090	guibg=bg
hi perlStatementSub 		gui=NONE        ctermfg=59 	 guifg=#c0c090 	guibg=bg
hi perlStringStartEnd		gui=NONE        ctermfg=22	 guifg=#b07050	guibg=bg
hi perlVarNotInMatches		gui=NONE        ctermfg=22	 guifg=#915555	guibg=bg
hi perlVarPlain				gui=NONE        ctermfg=22	 guifg=#74c5c6	guibg=bg
hi perlVarPlain2			gui=NONE        ctermfg=22	 guifg=#74c6a8	guibg=bg
hi perlVarSimpleMember		gui=NONE        ctermfg=59	 guifg=#c0c090	guibg=bg
hi perlVarSimpleMemberName	gui=NONE        ctermfg=70  	 guifg=grey70	guibg=bg
